    ...
    <asp:ListView runat="server" ID="providerDetails" ItemType="System.String"
        ...
        <EmptyDataTemplate>
            <div>
                ...
                <%--
                See <a href="https://go.microsoft.com/fwlink/?LinkId=252803">this article</a> for details on setting up this ASP.NET application to support logging in via external services.
                    --%>
                    </p>
            </div>
        </EmptyDataTemplate>
